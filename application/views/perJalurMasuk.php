...
<div class="toolbar" id="kt_toolbar">
    ...
    <div id="kt_toolbar_container" class="container-xl d-flex flex-stack">
        ...
        <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
            <!--begin::Title-->
            <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Perhitungan Per Jalur Masuk</h1>
            <!--end::Title-->
            <!--begin::Separator-->
            ...
            <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                ...
                <!--end::Item-->
                <!--begin::Item-->
                <li class="breadcrumb-item text-muted">Perhitungan Per Jalur Masuk</li>
                <!--end::Item-->
            </ul>
            <!--end::Breadcrumb-->
        </div>
                ...
                <div class="card card-xl-stretch mb-5 mb-xl-8">
                    ...
                    <div class="card-header border-0 pt-5">
                        ...
                        <div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover">
                            <h6>Pilih Jalur Masuk</h6>
                            <select onchange="toTablejalurMasuk()" id="select_jalur" class="form-select form-select-sm form-select-solid" data-control="select2" data-placeholder="Pilih Kategori Perhitungan" data-allow-clear="true">
                                <option></option>
                    ...
                    <div class="card-body py-3">
                        ...
                        <div class="table-responsive jalur-masuk"></div>
                        <!--end::Table container-->
                    </div>
                    <!--begin::Body-->
                </div>
