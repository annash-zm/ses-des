...
<div class="footer py-4 d-flex flex-lg-column" id="kt_footer">
						...
						<div class="container-xl d-flex flex-column flex-md-row align-items-center justify-content-between">
							...
							<div class="text-dark order-2 order-md-1">
								...
								<a href="" target="_blank" class="text-gray-800 text-hover-primary">Perhitungan SES-DES</a>
							</div>
							<!--end::Copyright-->
							<!--begin::Menu-->
		...
		<!--begin::Javascript-->
		<script>var hostUrl = "<?= base_url() ?>dist/assets/";</script>
		...
		<script src="<?= base_url() ?>dist/assets/js/custom/apps/chat/chat.js"></script>
		<script src="<?= base_url() ?>dist/assets/js/custom/utilities/modals/upgrade-plan.js"></script>
		<script src="<?= base_url() ?>dist/assets/js/custom/utilities/modals/create-app.js"></script>
		<script src="<?= base_url() ?>dist/assets/js/custom/utilities/modals/users-search.js"></script>
